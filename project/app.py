...
diet_pipeline = create_pipeline(diet_prompt_template, Config.OPENAI_API_KEY, document_store, model_name="gpt-4o") 
final_pipeline = create_pipeline(prompt_template, Config.OPENAI_API_KEY, document_store, model_name="gpt-4o")
